...
var woops = window.window.alert("I didnt understand. would you repeat?");
var inventory = {
        sword: 0,
        lamp: 0,
        rope: 0,
...
var checkLoot = function () {
    ...
    window.window.alert("This is how much you got" + inventory.loot);
...
var wizName = ["jimmy, dolf, brian, theo"];
  ...
  window.window.alert("legend of " + wizName[Math.floor(Math.random(0, 4))] + "!");
...
function Game() {
    ...
    function tunnels() {
     ...
     // the tunnel system begins
        ...
        if (enterTunnel === "yes" || enterTunnel === "y") {
            var i = 0;        
            while (i < 5) {
                var tunnel = window.prompt("It apears to be a maze with tunnels in all directions. Which way do you want to go? \n north \n east \n south \n west ");
                i++;
            }
    ...
    function Prison() {
        ...
        if (prison === "look around" || prison === "look") {
            var prisonLook = window.prompt("The Prison is small, dirty, and damp. A rat curries into a hole in the corner. There is a barred window to the back. a straw bed to the right. The cell bars and locked door to the front. \n move bed \n pick lock \n check pockets").toLocaleLowerCase();
            //move bed
            ...
            if (sleep === "yes" || sleep === "y") {
                ...
                window.alert("here we goooooooooo!");
                Prison();
            }
        ...
        if(swampEnv === "follow" ||swampEnv === "follow path"|| swampEnv === "north")
        {
            ...
            switch(swampPath) {     //burn hut
                case "burn" || "burn down hut":
                    ...
                    window.alert("the hut is quickly engulfed in flames. You hear a deathening shreak  and a smell of buring flesh begins to eminate from inside of the hut. You glory at the flames as they lick the walls of the hut and everything is quickly turned to cinder and smoke.");
                      // no more hut
                    var hut = false;
                    break;
                ...
                case "enter" && hut === true:
                    ...
                    if(hutSpace === "take sword" || hutSpace === "take")
                    {
                        ...
                        var hagAttack = window.prompt ("the hag notices you take her sword and runs at you with a ladle \n fight \n run").toLocaleLowerCase();
                                ...
                                // retry
                                    var hutRetry = window.prompt ("would you like to try again? \n yes").toLowerCase();
                    ...
                    var castle = window.prompt("You approach the castle. \n go in \n go east").toLocaleLowerCase();
                        ...
                        switch(well){
                            ...
                            case "look down" || "look":
                                ...
                                break;
                            case "go" || "go in":
                                window.alert("you grab the rope attached to the")
                                break;
                            case "west" || "head west":
