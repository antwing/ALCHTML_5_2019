...
function Game() {
    ...
    function Prison() {
        ...
        if (prison === "go back to sleep" || prison === "sleep") {
        ...
        if (prisonLook === "check" || prisonLook === "check pockets"){
            checkLoot();
            
        } 
        if (prisonLook === "lock" || prisonLook === "pick" || prisonLook === "pick lock") {
...
//next part 
    function Swamp () {
        ...
        //follow path
        if(swampEnv === "follow" ||swampEnv === "follow path"|| swampEnv === "north"|| swampEnv === "path")
        {
            var hut = true;
...
function Path(){ //follow path
                    ...
                    if (road === "west"){
                        ...
                        if(castle === "go" || castle === "in" || castle === "go in"){
